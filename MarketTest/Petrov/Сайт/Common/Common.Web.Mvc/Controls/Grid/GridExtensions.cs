...
namespace Common.Web.Mvc.Controls
{
	...
	public static class GridExtensions
	{
        ...
        public static IGridColumn<T> HeaderXlsxAttributes<T>(this IGridColumn<T> column, params Func<object, object>[] hash)
        {
            return column.HeaderXlsxAttributes(new Hash(hash));
        }
        ...
        public static IGridColumn<T> XlsxAttributes<T>(this IGridColumn<T> column, params Func<object, object>[] hash)
        {
            return column.XlsxAttributes(x => new Hash(hash));
        }
        ...
        /// <summary>
        /// Renders the header with 'select all' checkbox for the column.
        /// </summary>
        /// <param name="column">The current column</param>
        /// <returns></returns>
        public static IGridColumn<T> SelectAllCheckboxHeader<T>(this IGridColumn<T> column) where T : class
        {
            var checkboxTag = new TagBuilder("input");
            checkboxTag.MergeAttribute("type", "checkbox");
            checkboxTag.AddCssClass("select-all-checkbox");

            return Header<T>(column, "<th>" + checkboxTag.ToString(TagRenderMode.Normal) + "</th>");
        }
